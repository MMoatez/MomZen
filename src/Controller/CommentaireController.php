...
#[Route('/commentaire/new/{forum_id}', name: 'app_commentaire_new', methods: ['GET', 'POST'])]
public function new(Request $request, EntityManagerInterface $entityManager, int $forum_id): Response
{
    ...
    if ($form->isSubmitted() && $form->isValid()) {
        ...
        return $this->redirectToRoute('app_forum_show', ['id' => $forum_id], Response::HTTP_SEE_OTHER);
    }
