...
class User implements UserInterface, PasswordAuthenticatedUserInterface
{
    ...
    /**
     * @var Collection<int, Ambulance>
     */
    #[ORM\OneToMany(targetEntity: Ambulance::class, mappedBy: 'chauffeur')]
...
public function removeAmbulance(Ambulance $ambulance): static
{
    if ($this->ambulances->removeElement($ambulance)) {
        ...
        if ($ambulance->getChauffeur() === $this) {
            $ambulance->setChauffeur(null);
        }
    }
