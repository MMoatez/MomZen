...
class Analyse
{
    ...
    private ?DossierMedical $dossier_medicale = null;
    ...
    public function getDossierMedicale(): ?DossierMedical
    {
        return $this->dossier_medicale;
    }

    public function setDossierMedicale(?DossierMedical $dossier_medicale): static
    {
